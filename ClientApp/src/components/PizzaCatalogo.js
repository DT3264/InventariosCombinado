...
async function getPizzaData() {
  ...
  const response = await axios.get("pizza/withauth", options, {});
...
async function getSauces() {
  ...
  const response = await axios.get("pizza/sauce", options, {});
  console.log(response.data);
  return response.data;
}
async function getToppings() {
  ...
  const response = await axios.get("pizza/topping", options, {});
  console.log(response.data);
  return response.data;
}
